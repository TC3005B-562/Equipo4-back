...
public class AgentRepository {
    ...
    private List<Agent> agents = new ArrayList<>(); //list to store agents

    //findAll() return the list with all the current agents
    public List<Agent> findAll(){
        return this.agents;
    }

    //Dummy() creates 3 dummy agents and store them in the list
    public void Dummy(){
        Agent a1 = new Agent();
        a1.setId(1);
        a1.setAssociation("Amazon");
