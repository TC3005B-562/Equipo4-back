 ...
 */
public class EmployeeAmazonDynamoDBScanGeneratedCode {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println(LoadEmployees().get(0).getName());
            // Handle scanResult
    ...
    public static List<Employee> LoadEmployees(){
        ...
        try {
            ...
            for (Map<String, AttributeValue> item: scanResult.getItems()){
                employees.add(addEmployee(item));
                //System.out.println(item);
    ...
    private static Employee addEmployee(Map<String, AttributeValue> attributeList) {
        ...
        for (Map.Entry<String, AttributeValue> item : attributeList.entrySet()) {
            ...
            if (attributeName == "role"){ e.setRole(value.getS());}
            if (attributeName == "name"){ e.setName(value.getS());}
            if (attributeName == "mail"){ e.setMail(value.getS());}
            if (attributeName == "password"){ e.setPassword(value.getS());}
            if (attributeName == "validity_timestamp"){ e.setValidity_timestamp(value.getS());}

            if (attributeName == "employee_num"){ e.setEmployee_num(Integer.parseInt(value.getN()));}
            if (attributeName == "num_calls"){ e.setNum_calls(Integer.parseInt(value.getN()));}
            if (attributeName == "unsuccessful_tickets"){ e.setUnsuccessful_tickets(Integer.parseInt(value.getN()));}
            if (attributeName == "successful_tickets"){ e.setSuccessful_tickets(Integer.parseInt(value.getN()));}
            if (attributeName == "video_weight"){ e.setVideo_weight(Integer.parseInt(value.getN()));}

            if (attributeName == "agents"){ e.setAgents(value.getNS());}
            if (attributeName == "video_time_limit"){ e.setVideo_time_limit(value.getNS());}
